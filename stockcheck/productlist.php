...
$ltitle = Configuration::get('STOCK_CHECK_LTITLE', $langs);
...
<pageheader
        name="MyHeader1"
        content-left=""
        content-center="<?php echo $title.' / '.$subtitle; ?>"
        content-right=""
        header-style="font-family: serif; font-size: 15pt; font-weight: bold; color: <?php if (_PS_VERSION_ < '1.6.0.0') {
            echo '#';
        } ?><?php echo $w5; ?>;"
        line="on"/>
...
<div class="container">
    <div class="row">
        <table width="100%"
            ...
            <tr>
                <td align="center">
                    <img src="<?php echo __PS_BASE_URI__.'img/'.(_PS_VERSION_ > '1.5.0.0' ? Configuration::get('PS_LOGO') : 'logo.jpg'); ?>">
                </td>
            </tr>
            <tr>
                <td align="center">
                    <h1><?php echo $ltitle; ?></h1>
                </td>
            </tr>
        </table>
        <table width="99%"
               ...
               repeat_header="1"
               class="table">
            <tr bgcolor="<?php if (_PS_VERSION_ < '1.6.0.0') {
                echo '#';
            } ?><?php echo $w4; ?>">
                <th align="center"
                    style="color:#ccc"><?php echo $limage; ?></th>
                <th align="center"
                    style="color:#ccc"><?php echo $lname; ?></th>
                <th align="center"
                    style="color:#ccc"><?php echo $lref; ?></th>
                <th align="center"
                    style="color:#ccc"><?php echo $ldescription; ?></th>
                <th align="center"
                    style="color:#ccc"><?php echo $lstock; ?></th>
                <th align="center"
                    style="color:#ccc"><?php echo $lprice; ?>
                    (<?php echo $sign; ?>
                    )
                </th>
                <th align="center"
                    style="color:#ccc"><?php echo $lpricetax; ?>
                    (<?php echo $sign; ?>
                    )
                </th>
            </tr>
            ...
            foreach ($sorgu as $veri) {
                ...
                <td valign="top"><span
                            style="color:#f26822"><a
                                href="<?php echo $linkr; ?>"
                                target="_blank"
                                style="color:<?php if (_PS_VERSION_ < '1.6.0.0') {
                                    echo '#';
                                } ?><?php echo $w2; ?>; text-decoration:none"><?php echo $veri['name']; ?></a></span>
                </td>
                ...
                <td width="65"
                    ...
                    if ($veri4at == null)
                    ?></strong>
                    <span> <?php if ($veri4at == null)
                        echo((_PS_VERSION_ > '1.5.0.0') ? $veri["qty"] : $veri['quantity']) ?>
                </td>
                <td width="100"
                    align="right"
                    valign="top"><?php
                    if (_PS_VERSION_ > '1.5.0.0') {
                        echo @Tools::displayPrice(Product::getPriceStatic($veri['id_product'], $usetax = false, $veri4['id_product_attribute'] = null, $decimals = 2, $divisor = null, $only_reduc = false, $usereduc = true, $quantity = 1, $forceAssociatedTax = false, $id_customer, $id_cart = null, $id_address, $specificPriceOutput = null, $with_ecotax = true, $use_groupReduction = true, $context = null, $use_customer_price = true));
                    } else {
                        echo @Tools::displayPrice(Product::getPriceStatic($veri['id_product'], $usetax = false, $veri4['id_product_attribute'] = null, $decimals = 2, $divisor = null, $only_reduc = false, $usereduc = true, $quantity = 1, $forceAssociatedTax = false, $id_customer, $id_cart = null, $id_address, $specificPriceOutput = null, $with_ecotax = true, $use_groupReduction = true, $currencya));
                    }
                    ?></td>
                <td width="77"
                    align="right"
